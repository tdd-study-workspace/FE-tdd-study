/**
 * 이 코드는 현재 Storybook에서 Vue3 Docs Addon을 사용할 수 없는 문제를 해결하기 위해 작성되었습니다.
 * 이 후 이 코드를 사용하지 않고 Docs Addon을 사용할 수 있게 되면 삭제해주세요.
 * 이 코드는 preview.js 에서 custom decorator로 사용됩니다.
 */
